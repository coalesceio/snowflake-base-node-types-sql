...
SELECT
    ...
    "N_NATIONKEY"                            AS "N_NATIONKEY"          @id("11c2e2") @isBusinessKey,
    "N_NAME"                                 AS "N_NAME"               @id("00270b"),
    "N_REGIONKEY"                            AS "N_REGIONKEY"          @id("abcafd"),
    "N_COMMENT"                              AS "N_COMMENT"            @id("6e8a9a"),
    "N_LOAD_TIMESTAMP"                       AS "N_LOAD_TIMESTAMP"     @id("846c6f"),
